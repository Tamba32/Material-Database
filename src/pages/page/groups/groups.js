const GROUPS = [
  ...
  { 
    ...
    time: '2nd and 4th Saturdays of the month 12-2 Beginning: DATE: Saturday, November 9, 2013 Recurring Time and Room: 12 – 2:30 p.m. 4-163 (tiered, seats 81, tablet armchairs, video projector)',
    size: {
      undergraduate: 35,
      graduate: 0,
      mitCommunity: 1,
  ...
  { 
    ...
    time: 'Wednesday 5pm once a month',
    size: {
      undergraduate: 10,
      graduate: 3,
      mitCommunity: 5,
  ...
  { 
    ...
    time: 'We have a general group meeting every Saturday at 1pm for photography tutorials, darkroom lessons, photoshop help, etc.',
    size: {
      undergraduate: 60,
      graduate: 20,
      mitCommunity: 5,
  ...
  { 
    ...
    time:  'General body meeting twice a semester; check group website for details.',
    size: {
      undergraduate: 0,
      graduate: 800,
      mitCommunity: 0,
  ...
  { 
    ...
    time: "set by each year's committee",
    size: {
      undergraduate: 5,
      graduate: 2,
      mitCommunity: 0,
  ...
  { 
    ...
    time: 'Shabbat Services and Dinner every Friday Night (6pm Services, 7pm Dinner) General Body Meeting held at the end of the Fall Term.',
    size: {
      undergraduate: 350,
      graduate: 225,
      mitCommunity: 1400,
  ...
  { 
    ...
    time: 'M 9-11PM W 9-11PM R 9-11PM Su 3-5PM',
    size: {
      undergraduate: 10,
      graduate: 7,
      mitCommunity: 10,
  ...
  { 
    ...
    time: 'Sunday: 4-6 PM (McCormick Dance Studio) Wednesday: 9-10 PM (McCormick Dance Studio)',
    size: {
      undergraduate: 8,
      graduate: 0,
      mitCommunity: 0,
